...
async function getUpload(filename) {
  ...
  return localRead(path.join('uploads', filename));
}
...
// Naudmodus: serv standardinnhald om lageret ikkje kan initialiserast (t.d. GitHub nede ved kaldstart)
...
module.exports = {
  init, initFallback, getContent, getMessages, saveContent, saveMessages, addMessage,
  saveUpload, getUpload, deleteUpload, listUploads, remote,
};
